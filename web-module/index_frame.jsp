<%--
 * ==============================================================================================
 * $Id: index_frame.jsp,v 1.1 2014/11/14 03:14:30 asiapacific\hsiehes Exp $
 * ==============================================================================================
--%>
	...
	<body class="layoutPage">
		<div widgettype="LayoutContainer" id="layoutContainer" layoutstyle='top-bottom' style="width: 100%; height: 100%;">
				...
				<div id="userInfo">
					<table width="100%" border="0" cellspacing="0" cellpadding="2">
						<tr>
							...
							<td class="nowrap">
								[<c:out value='${sessionScope.userProfile.userInfo.departmentID}'/>]<c:out value='${sessionScope.userProfile.userInfo.signature}'/>
							</td>
						</tr>
						<tr>
							<td class="nowrap"><fmt:message key="label.login.timestamp"/></td>
							<td class="nowrap">				
								<edstw:formatDate value="${sessionScope.userProfile.userInfo.loginTimestamp}" pattern="${dateUtil.fullPattern}"/>
							</td>
						</tr>
					</table>
				</div>
			...
			<div widgettype="LayoutContainer" id="splitContainerH" layoutalign="bottom" layoutstyle='left-right' toggleposition="left" splitsize="3" activesizing="true">
				...
				<div widgettype="ContentPane" id="mainContentPane">
					<iframe id="mainContentFrame" src="<c:url value='/blank.jsp'/>" frameborder="0" style="width: 100%; height: 100%"></iframe>
				</div>
			</div>
		</div>
		<script type="text/javascript">
