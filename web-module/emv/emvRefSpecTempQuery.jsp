...
<html>
	<head>
		<title><c:out value='參考規格維護覆核'/></title>
	...
	<div id="page">
		<div id="mainContentBlock" style="width:70%;margin:0 auto;">
			<div id="progHeader">
				<div id="progTitle" title="程式代碼 : <c:out value='${currentFunctionObj.id}'/>"><c:out value='參考規格維護覆核'/></div>
			</div>
			<jsp:include page="/jsp/messages.jsp"/>
			<s:form action="queryEmvRefSpecTemp">
				<s:hidden name="entity.pagingInfo.enablePaging" value="true"/>
				<s:hidden name="entity.uiLogAction" value=""/>
				<s:hidden name="entity.uiLogFunctionName" value="參考規格"/>
