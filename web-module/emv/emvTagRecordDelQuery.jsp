...
<html>
	...
	<div id="page">
		<div id="mainContentBlock" style="width: 80%;">
			<div id="progHeader">
				<div id="progTitle" title="程式代碼 : <c:out value='${currentFunctionObj.id}'/>">EMV TAG刪除查詢</div>
			</div>
			<jsp:include page="/jsp/messages.jsp"/>
			<c:set var="cardTypeList" value="${paramBean.emvCardTypeList}" />
			<s:form action="queryEmvTagRecordDel">
				<%-- 設定開啟分頁功能 --%>
				<s:hidden name="entity.pagingInfo.enablePaging" value="true"/>
				<s:hidden name="entity.pagingInfo.currentPage" value="1"/>
				<edstw:folding foldingId="criteriaBlock" description="查詢條件" style="width: 500px;text-align:center;">
					<fieldset>
						<legend>查詢條件</legend>
