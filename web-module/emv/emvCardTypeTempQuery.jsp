...
<html>
	<head>
		<title><c:out value='EMV卡別維護覆核'/></title>
		<%@include file="/jsp/header.jsp"%>	
	</head>
	<body onload="showPage();">
	<div id="page">
		<div id="mainContentBlock" style="width:60%;margin:0 auto;">
			<div id="progHeader">
				<div id="progTitle" title="程式代碼 : <c:out value='${currentFunctionObj.id}'/>"><c:out value='EMV卡別維護覆核'/></div>
			</div>
			<jsp:include page="/jsp/messages.jsp"/>
			<s:form action="queryEmvCardTypeTemp">
