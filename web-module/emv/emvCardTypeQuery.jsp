...
<html>
	<head>
		<title><c:out value='EMV卡別維護'/></title>
		<%@include file="/jsp/header.jsp"%>	
	</head>
	<body onload="showPage();">
	<div id="page">
		<div id="mainContentBlock" style="width:50%;margin:0 auto;">
			<div id="progHeader">
				<div id="progTitle" title="程式代碼 : <c:out value='${currentFunctionObj.id}'/>"><c:out value='EMV卡別維護'/></div>
			</div>
			<jsp:include page="/jsp/messages.jsp"/>
			<s:form action="queryEmvCardType">
