...
<div style="margin:10px 0;text-align:left;">
	<a 
	href="<c:url value='toCreateEmvCardType.do'/>"
	onclick="showIFrameDialog( this, {title: '<c:out value='EMV卡別維護'/>'}); return false;" title="新增">
	...
	<c:forEach var="item" items="${resultList}" varStatus="status">
		<tr class="<edstw:rowStyle value='${status.index}'/>">
			...
			<c:choose>
				...
				<a
				href="<c:url value='/emv/toModifyEmvCardType.do?entity.cardType=${item.cardType}'/>"
				onclick="showIFrameDialog( this, {title: '<c:out value='EMV卡別維護'/>'}); return false;"
				title="修改"><img src="../images/pen.gif"></a>
				<a 
				href="<c:url value='/emv/deleteEmvCardType.do?entity.cardType=${item.cardType}'/>"
