...
<body class="ieVersion">
				...
				<tbody>
					<tr class="oddRow">
						...
						<td align="center"><c:if test="${entity.fromEdcDate != null && entity.fromEdcDate != '' && entity.fromEdcDate != '        '}"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=FROM%20EDC&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}&cardType=${entity.cardType}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
						...
						<td align="center"><c:if test="${entity.toEdcDate != null && entity.toEdcDate != '' && entity.toEdcDate != '        '}"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=TO%20EDC&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
					</tr>
					<c:choose>
					<c:when test="${ paramBean.eWalletNameMap[entity.cardType] ne null }" >
						<tr class="evenRow">
							<td align="center">SPSW</td>
							<td align="center"><c:out value="${entity.fromSpswDate}" /></td>
							<td align="center"><c:out value="${entity.fromSpswTime}" /></td>
							<td align="center"><c:if test="${entity.fromSpswDate != null && entity.fromSpswDate != '' && entity.fromSpswDate != '        '}"><button type="button" class="button"
									onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=FROM%20SP%20SWITCH&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}&cardType=${entity.cardType}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
							<td align="center"><c:out value="${entity.toSpswDate}" /></td>
							<td align="center"><c:out value="${entity.toSpswTime}" /></td>
							<td align="center"><c:if test="${entity.toSpswDate != null && entity.toSpswDate != '' && entity.toSpswDate != '        '}"><button type="button" class="button"
									onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=TO%20SP%20SWITCH&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}&cardType=${entity.cardType}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
						</tr>
					</c:when>
					<c:otherwise>
						<tr class="evenRow">
							...
							<td align="center"><c:if test="${entity.fromBase24Date != null && entity.fromBase24Date != '        ' && entity.fromBase24Date !='' }"><button type="button" class="button"
									onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=FROM%20B24&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
							...
							<td align="center"><c:if test="${entity.toBase24Date != null && entity.toBase24Date != '        ' && entity.toBase24Date != ''}"><button type="button" class="button"
									onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=TO%20B24&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
						</tr>
					</c:otherwise>
					</c:choose>
					<tr class="oddRow">
						...
						<td align="center"><c:if test="${entity.fromAsmDate != null && entity.fromAsmDate != '        ' && entity.fromAsmDate !='' }"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=FROM%20ASM&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
						...
						<td align="center"><c:if test="${entity.toAsmDate != null && entity.toAsmDate != '        ' && entity.toAsmDate !='' }"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=TO%20ASM&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
					</tr>
					<tr class="evenRow">
						...
						<td align="center"><c:if test="${entity.fromTmsDate != null && entity.fromTmsDate != '        ' && entity.fromTmsDate != ''}"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=FROM%20TMS&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
						...
						<td align="center"><c:if test="${entity.toTmsDate != null && entity.toTmsDate != '        ' && entity.toTmsDate !='' }"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=TO%20TMS&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
					</tr>
					<c:if test="${'S' eq entity.cardType}">
						<tr class="oddRow">
							...
							<td align="center"><c:if test="${entity.fromEdcConfDate != null && entity.fromEdcConfDate != '' && entity.fromEdcConfDate != '        '}"><button type="button" class="button"
									onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=FROM%20EDC%20CONFIRM&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
							...
							<td align="center"><c:if test="${entity.toEdcConfDate != null && entity.toEdcConfDate != '' && entity.toEdcConfDate != '        '}"><button type="button" class="button"
									onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=TO%20EDC%20CONFIRM&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
						</tr>
						<tr class="evenRow">
							...
							<td align="center"><c:if test="${entity.toSpswConfDate != null && entity.toSpswConfDate != '        ' && entity.toSpswConfDate != '' }"><button type="button" class="button"
									onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=TO%20SP%20SWITCH%20CONFIRM&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
						</tr>
					</c:if>
					<%-- UPLAN-M2018187  --%>
					<c:if test="${'Y' eq entity.uplanFlag}">
					<tr class="oddRow">
						<td align="center">BASE24(UPLAN)</td>
						<td align="center"><c:out value="${entity.fromUplanDate}" /></td>
						<td align="center"><c:out value="${entity.fromUplanTime}" /></td>
						<td align="center"><c:if test="${entity.fromUplanDate != null && entity.fromUplanDate != '        ' && entity.fromUplanDate != ''}"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=FROM%20UPLAN&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
						<td align="center"><c:out value="${entity.toUplanDate}" /></td>
						<td align="center"><c:out value="${entity.toUplanTime}" /></td>
						<td align="center"><c:if test="${entity.toUplanDate != null && entity.toUplanDate != '        ' && entity.toUplanDate != ''}"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseISOCode.do?rawType=TO%20UPLAN&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
					</tr>
					</c:if>
					<%-- M2020218_UNY  --%>
					<c:if test="${fn:startsWith(entity.edcPosEntryMode, '503')}">
					<tr class="oddRow">
						<td align="center">UNY</td>
						<td align="center"><c:out value="${entity.fromUnyDate}" /></td>
						<td align="center"><c:out value="${entity.fromUnyTime}" /></td>
						<td align="center"><c:if test="${entity.fromUnyDate != null && entity.fromUnyDate != '        ' && entity.fromUnyDate != ''}"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseUnyCode.do?rawType=FROM%20UNY&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}&cardType=${entity.cardType}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
						<td align="center"><c:out value="${entity.toUnyDate}" /></td>
						<td align="center"><c:out value="${entity.toUnyTime}" /></td>
						<td align="center"><c:if test="${entity.toUnyDate != null && entity.toUnyDate != '        ' && entity.toUnyDate != ''}"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseUnyCode.do?rawType=TO%20UNY&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
					</tr>
					<tr class="evenRow">
						<td align="center">UNY NOTIFY</td>
						<td align="center"></td>
						<td align="center"></td>
						<td align="center"></td>
						<td align="center"><c:out value="${entity.toUnyDate}" /></td>
						<td align="center"><c:out value="${entity.toUnyTime}" /></td>
						<td align="center"><c:if test="${entity.toUnyDate != null && entity.toUnyDate != '        ' && entity.toUnyDate != ''}"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseUnyCode.do?rawType=TO%20UNY%20NOTIFY&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
					</tr>
					</c:if>
					<%-- M2024060_TRUST  --%>
					<c:if test="${'0957' eq entity.nii}">
					<tr class="oddRow">
						<td align="center">TRUST</td>
						<td align="center"><c:out value="${entity.fromTrustDate}" /></td>
						<td align="center"><c:out value="${entity.fromTrustTime}" /></td>
						<td align="center"><c:if test="${entity.fromTrustDate != null && entity.fromTrustDate != '        ' && entity.fromTrustDate != ''}"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseTrustCode.do?rawType=FROM%20TRUST&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}&cardType=${entity.cardType}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
						<td align="center"><c:out value="${entity.toTrustDate}" /></td>
						<td align="center"><c:out value="${entity.toTrustTime}" /></td>
						<td align="center"><c:if test="${entity.toTrustDate != null && entity.toTrustDate != '        ' && entity.toTrustDate != ''}"><button type="button" class="button"
								onclick="showIFrameDialog('<c:url value="/trans/parseTrustCode.do?rawType=TO%20TRUST&seqId=${entity.seqId}&maskCardNo=${entity.maskCardNo}&edcSpec=${entity.edcSpec}"/>',{width:1040, height:'480',title: 'ISO'});return false;">ISO</button></c:if></td>
					</tr>
					</c:if>
					<tr>
		...
		<table border="0" cellpadding="4" cellspacing="1" class="listTable"
			...
			<tr class="evenRow">
				<td class="optional"><a href="#"
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=ProcessingCode"/>',{width:1000, height:'400',title: 'Processing Code'});return false;"
					style="text-decoration: underline; color: blue;">EDC Processing
						Code</a></td>
				<td width="18%"><c:out value="${entity.edcProcCode}" /></td>
				<td class="optional"><a href="#"
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=ProcessingCode"/>',{width:1000, height:'400',title: 'B24 Processing Code'});return false;"
			...
			<tr class="oddRow">
				<td class="optional"><a href="#"
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=EDCPOSEntryMode"/>',{width:1000, height:'400',title: 'EDC POS Entry Mode'});return false;"
			...
			<tr class="evenRow">
				...
				<td class="optional">
					...
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=FiscConditionCode"/>',{width:1000, height:'400',title: 'FISC POS Condition Code'});return false;"
			...
			<tr class="evenRow">
				<td class="optional"><a href="#"
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=CardholderPresentIndicator"/>',{width:1000, height:'320',title: 'Cardholder Present Indicator'});return false;"
				...
				<td class="optional"><a href="#"
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=CardPresentIndicator"/>',{width:1000, height:'400',title: 'Card Present Indicator'});return false;"
					style="text-decoration: underline; color: blue;">Card Present
						Indicator</a></td>
				<td width="18%"><c:out value="${entity.cardPresentInd}" /></td>
				<td class="optional"><a href="#"
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=TransactionStatusIndicator"/>',{width:1000, height:'400',title: 'Transaction Status Indicator'});return false;"
			...
			<tr class="oddRow">
				<td class="optional"><a href="#"
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=TransactionSecurityIndicator"/>',{width:1000, height:'400',title: 'Transaction Security Indicator'});return false;"
					style="text-decoration: underline; color: blue;">Transaction
						Security Indicator</a></td>
				<td width="18%"><c:out value="${entity.tranSecInd}" /></td>
				<td class="optional"><a href="#"
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=CATIndicator"/>',{width:1000, height:'400',title: 'CAT Indicator'});return false;"
			...
			<tr class="evenRow">
				<td class="optional"><a href="#"
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=TerminalInputCapabilityIndicator"/>',{width:1000, height:'400',title: 'Terminal Input Capability Indicator'});return false;"
			...
			<tr class="oddRow">
				...
				<c:choose>
				<c:when test="${'IP' eq entity.cardType || 'EZ' eq entity.cardType || 'IC' eq entity.cardType || 'HC' eq entity.cardType}">
				<td class="optional">電票回應碼</td>
				<td width="18%">
					<c:out value="${entity.swRespCode}" />
				</td>
				</c:when>
				<c:otherwise>
				...
				<td class="optional">RF序號</td>
				<td width="18%"><c:out value="${entity.atsEsvcTxnNum}" /></td>
			...
			<tr class="evenRow">
				...
				<td class="optional"><a href="#"
					onclick="showIFrameDialog('<c:url value="/trans/parseFixedCode.do?fixedCodeType=ExchangeMode"/>',{width:1000, height:'400',title: '優惠兌換方式'});return false;"
			...
			<tr class="oddRow">
				...
				<td class="optional">是否為小額付款</td>
				<td width="18%"><c:out value="${entity.mpasFlag}" /></td>
			</tr>
			<tr class="evenRow">
				<td class="optional">行動感應支付</td>
				<td width="18%"><c:out value="${entity.mcpInd}" /></td>
				<td class="optional">銀聯優惠序號(Coupon ID)</td>
				<td width="18%"><c:out value="${entity.upCouponId}" /></td>
				<td class="optional">Token Requestor ID</td>
				<td width="18%"><c:out value="${entity.tokenReqId}" /></td>
			</tr>
			<tr class="evenRow">
				<td class="optional">交易碼</td>
				<td width="18%"><c:out value="${entity.unyTranCode}" /></td>
				<td class="optional">持卡人簽帳單存根聯</td>
				<td width="18%"><c:if test="${entity.showChesg}">
						<a href="#" onclick="copyESCToClipboard()" title="複製簽帳單網址"> <input
							type="Button" name="reportButton" value="複製簽帳單網址" class="button">
						</a>
					</c:if></td>
	...
	<script type='text/javascript'>
		function copyESCToClipboard() {
			const url = "<c:out value='${entity.chesgUri}' />";
