...
Object.extend(Date.prototype,
{
	SimpleFormat: function(format, data)
	{
		...
		for (var sect in bits)
		{
			...
			EdsLog.debug(sect + ":" + bits[sect] + ":" + reg );
