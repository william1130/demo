 ...
 */
class Z_UncompressInputStream extends FilterInputStream {
    /**
     * @param is
     ...
     */
    public Z_UncompressInputStream(InputStream is) throws IOException {
        super(is);
        parse_header();
    }
    ...
    public void main(String args[]) throws Exception {
        ...
        InputStream in = new Z_UncompressInputStream(new FileInputStream(args[0]));
