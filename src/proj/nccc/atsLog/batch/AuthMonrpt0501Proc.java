...
import proj.nccc.atsLog.batch.process.AuthMonrpt0501ProcImpl;
...
/**
 * - 執行auth_monrpt_0501 (非會員銀行之每日人工授權交易分析月報(MGAUTH501))
 *
 */
@Log4j2
public class AuthMonrpt0501Proc extends BatchBaseMain {
	...
	public void process(String jobId,String user,String[] args) throws Exception {
		...
		try {
			if(super.init(jobId)) {
				...
				AuthMonrpt0501ProcImpl impl = new AuthMonrpt0501ProcImpl(jobId);
	...
	{
		AuthMonrpt0501Proc proc = new AuthMonrpt0501Proc();
		
		String jobId="MGAUTH501";
		String user="SYSTEM";
