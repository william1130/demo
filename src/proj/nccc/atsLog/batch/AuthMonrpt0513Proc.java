...
import proj.nccc.atsLog.batch.process.AuthMonrpt0513ProcImpl;
...
/**
 * - 執行auth_monrpt_0513 (AE每日人工授權交易檔(MGAUTH513))
 *
 */
@Log4j2
public class AuthMonrpt0513Proc extends BatchBaseMain {
	...
	public void process(String jobId,String user,String[] args) throws Exception {
		...
		try {
			if(super.init(jobId)) {
				...
				AuthMonrpt0513ProcImpl impl = new AuthMonrpt0513ProcImpl(jobId);
	...
	{
		AuthMonrpt0513Proc proc = new AuthMonrpt0513Proc();
		
		String jobId="MGAUTH513";
		String user="SYSTEM";
