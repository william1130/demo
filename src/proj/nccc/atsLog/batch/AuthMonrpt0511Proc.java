...
import proj.nccc.atsLog.batch.process.AuthMonrpt0511ProcImpl;
...
/**
 * - 執行auth_monrpt_0511 (非會員銀行之每日人工授權交易檔(MGAUTH511))
 *
 */
@Log4j2
public class AuthMonrpt0511Proc extends BatchBaseMain {
	...
	public void process(String jobId,String user,String[] args) throws Exception {
		...
		try {
			if(super.init(jobId)) {
				...
				AuthMonrpt0511ProcImpl impl = new AuthMonrpt0511ProcImpl(jobId);
	...
	{
		AuthMonrpt0511Proc proc = new AuthMonrpt0511Proc();
		
		String jobId="MGAUTH511";
		String user="SYSTEM";
