...
@Log4j2
public class AuthMonrpt0502ProcImpl extends AbstractRptAtslogProc{
	...
	public AuthMonrpt0502ProcImpl(String jobId) {
		this.jobId = jobId;
	}
	...
	public ReturnVO process(String processMonth) throws Exception {
		...
		try {
			...
			List<Map<String, Object>> listData = authLogDataDao.queryMonrtp502Data(super.getStartDate(), super.getEndDate());
			List<Map<String, Object>> listSummary = authLogDataDao.queryMonrtp502Summary(super.getStartDate(), super.getEndDate());
	...
	private List<String> writeLine(List<Map<String, Object>> list, boolean summary) throws Exception {
		...
		for(Map<String, Object> map : list) {
			...
			String businessType = MapUtils.getString(map, "BUSINESS_TYPE", "");
	...
	private List<String> reportTitle(){
		...
		title.add("交易日期,特店類別,卡別,授權結果,筆數,");
		return title;
	}
	...
	String getReportName() {
		return "會員銀行之每日人工授權交易分析月報表";
	}
	@Override
	String getFileName() {
		return this.processMm + "MGAUTH502.csv";
	}
