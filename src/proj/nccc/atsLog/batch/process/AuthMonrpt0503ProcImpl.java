...
@Log4j2
public class AuthMonrpt0503ProcImpl extends AbstractRptAtslogProc{
	...
	public AuthMonrpt0503ProcImpl(String jobId) {
		this.jobId = jobId;
	}
	...
	public ReturnVO process(String processMonth) throws Exception {
		...
		try {
			...
			List<Map<String, Object>> listData = authLogDataDao.queryMonrtp503Data(super.getStartDate(), super.getEndDate());
			List<Map<String, Object>> listSummary = authLogDataDao.queryMonrtp503Summary(super.getStartDate(), super.getEndDate());
	...
	String getReportName() {
		return "AE每日人工授權交易分析月報表";
	}
	@Override
	String getFileName() {
		return this.processMm + "MGAUTH503.csv";
	}
