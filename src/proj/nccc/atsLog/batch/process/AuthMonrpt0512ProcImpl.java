...
@Log4j2
public class AuthMonrpt0512ProcImpl extends AbstractRptAtslogProc{
	...
	public AuthMonrpt0512ProcImpl(String jobId) {
		this.jobId = jobId;
	}
	...
	public ReturnVO process(String processMonth) throws Exception {
		...
		try {
			...
			List<Map<String, Object>> listData = authLogDataDao.queryMonrtp512Data(super.getStartDate(), super.getEndDate());
	...
	private List<String> reportTitle(){
		...
		title.add("交易日期,交易時間,商店代號,特店類別,行業別,金額,銀行別,卡別,授權結果,");
		return title;
	}
	...
	String getReportName() {
		return "會員銀行之每日人工授權交易檔";
	}
	@Override
	String getFileName() {
		return this.processMm + "MGAUTH512.csv";
	}
