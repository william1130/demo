...
import proj.nccc.logsearch.persist.LDSSTransLog;
 ...
 * @version 1.0
 */
public class LDSSTransLogArg extends LDSSTransLog implements ProjArg
{
	/**
	 * 
	 */
	...
	// M2020020
	private List<LDSSRawLog> rawList;
	...
	public List<LDSSRawLog> getRawList() {
		return rawList;
	}

	public void setRawList(List<LDSSRawLog> rawList) {
