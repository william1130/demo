 ...
 * @version 1.0
 */
public class IFESTransLogProcImpl extends ProjProc {

	public int queryCount(IFESTransLogArg arg) {
	 ...
	 */
	public List<IFESTransLogArg> getList(IFESTransLogArg arg) throws ProcessException {
		...
		try {
			...
			// 交易類別
			Map<String, String> transTypeMap = ParamBean.getInstance().getIfesTransTypeNameMap();

			// set
			for (IFESTransLogArg obj : list) {
				String hostAccord = StringUtils.trimToEmpty(obj.getHostAccord());
				String transTypeName = transTypeMap.get(hostAccord + "," + obj.getMti() + "," + obj.getProcCode());
	...
	public void setArg(IFESTransLogArg arg, String maskCardNo, String showCardIso, String merchantChinName,
