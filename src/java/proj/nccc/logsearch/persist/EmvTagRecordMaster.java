...
/**
 * table=emv_tag_record
 * @author Gail Lee
 * @version 1.0
 */

public class EmvTagRecordMaster extends AbstractProjPersistable {
	...
	public class EmvTagRecordMasterId extends CompositeId {
		public EmvTagRecordMasterId(String emvTag, String sameValueFlag) {
	...
	public boolean equals(Object obj) {
		...
		final EmvTagRecordMaster other = (EmvTagRecordMaster) obj;
	...
	public Object getId() {
		...
		return new EmvTagRecordMasterId(emvTag, sameValueFlag);
	}
