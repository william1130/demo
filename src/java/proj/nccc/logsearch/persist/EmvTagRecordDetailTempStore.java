...
public class EmvTagRecordDetailTempStore extends ProjStore {
	...
	public EmvTagRecordDetailTempStore() {
	}
	...
	public String getTableName() {
		return "EMV_TAG_RECORD_DETAIL_TEMP";
	}
	...
	protected void insert(Persistable persistable, PreparedStatement pstmt)
			throws SQLException {
		int i = 1;
		EmvTagRecordDetailTemp o = (EmvTagRecordDetailTemp) persistable;
